			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" method="POST">
						...
						<div class="right-w3l">
							<input type="submit" class="form-control" value="Register" name="register" data-toggle="modal" data-target="#success_alert">
						</div>
					</form>
				</div>
			</div>
...
<div class="modal fade" id="success_alert" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
