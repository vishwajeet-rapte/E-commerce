								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												...
												<?php
													switch ($id) {
														case '1':	?>
															<a href="single.php?id=<?php echo $id; ?>" class="link-product-add-cart">Quick View</a>
												<?php			break;

														case '2':	?>
															<a href="oppo.php?id=<?php echo $id; ?>" class="link-product-add-cart">Quick View</a>
												<?php			break;

														case '3':	?>
															<a href="apple.php?id=<?php echo $id; ?>" class="link-product-add-cart">Quick View</a>
												<?php			break;
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.php"> <?php echo $product_name; ?> </a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price"> Rs. <?php echo $product_price; ?> </span>
												<del> MRP. <?php echo $product_MRP; ?> </del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
													<fieldset>
														...
														<a href="checkout.php?id=<?php echo $id; ?>" ><input type="button" value="Buy Now" class="button btn" ></a>
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price">Rs.320.00</span>
												<del>Rs.340.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price">Rs.349.00</span>
												<del>Rs.399.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price">Rs.249.00</span>
												<del>Rs.300.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price">Rs.230.00</span>
												<del>Rs.280.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price">Rs.180.00</span>
												<del>Rs.200.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="info-product-price my-2">
												<span class="item_price">Rs.199.00</span>
												<del>Rs.299.00</del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="#" method="post">
								...
								<div class="scroll">
									<div class="row">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											...
											<a href="" class="price-mar mt-2">Rs.12,990.00</a>
										</div>
									</div>
									<div class="row my-4">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											...
											<a href="" class="price-mar mt-2">Rs.12,499.00</a>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
										...
										<div class="col-lg-9 col-sm-10 col-9 w3_mvd">
											...
											<a href="" class="price-mar mt-2">Rs.1,199.00 </a>
										</div>
									</div>
								</div>
							</div>
