		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/oppo_front.jpg">
									<div class="thumb-image">
										<img src="images/oppo_front.jpg" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="images/oppo_side.png">
									<div class="thumb-image">
										<img src="images/oppo_side.png" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
								<li data-thumb="images/oppo_back.png">
									<div class="thumb-image">
										<img src="images/oppo_back.png" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
							</ul>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					...
					<p class="mb-3">
						<span class="item_price">Rs.200.00</span>
						<del class="mx-2 font-weight-light">Rs.280.00</del>
						...
						<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							<form action="#" method="post">
								<fieldset>
									...
									<a href="checkout.php?id=<?php echo $getid; ?>" ><input type="button" value="Buy Now" class="button btn" ></a>
